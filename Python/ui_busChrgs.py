...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QRect(200, 90, 231, 41))
...
"}")
        ...
        self.lineEdit_20.setGeometry(QRect(300, 160, 81, 31))
        font = QFont()
...
"}")
        ...
        self.label_11.setGeometry(QRect(200, 160, 101, 31))
...
"}")
        ...
        self.lineEdit_21.setGeometry(QRect(300, 200, 111, 31))
...
"}")
        ...
        self.lineEdit_22.setGeometry(QRect(300, 240, 111, 31))
...
"}")
        ...
        self.lineEdit_22.setEchoMode(QLineEdit.Password)
        self.lineEdit_22.setCursorPosition(0)
        self.lineEdit_22.setReadOnly(False)
        self.label_8 = QLabel(self.frame)
        self.label_8.setObjectName(u"label_8")
        self.label_8.setGeometry(QRect(180, 240, 101, 31))
...
"}")
        ...
        self.label_9.setGeometry(QRect(190, 200, 91, 31))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"Bus Travel Charges", None))
        ...
        self.lineEdit_21.setPlaceholderText(QCoreApplication.translate("MainWindow", u"User ID", None))
        self.lineEdit_22.setInputMask("")
        self.lineEdit_22.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Password", None))
        self.label_8.setText(QCoreApplication.translate("MainWindow", u" Password :", None))
        self.label_9.setText(QCoreApplication.translate("MainWindow", u" Admin ID :", None))
    # retranslateUi
